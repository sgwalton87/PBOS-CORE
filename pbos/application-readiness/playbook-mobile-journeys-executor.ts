...
import { readPlaybookMobileFoundationManifest } from "./playbook-readiness-manifests";
...
const foundation=readPlaybookMobileFoundationManifest(await dependencies.gateway.readFileAtRevision(reference,FOUNDATION_MANIFEST,inspection.revision));
