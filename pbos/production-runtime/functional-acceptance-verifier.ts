...
const executableSources: Readonly<Record<ApplicationAcceptanceDimension, readonly ApplicationAcceptanceEvidence["source"][]>> = {
    ROUTE: ["RUNTIME_PROBE", "BROWSER_JOURNEY", "NATIVE_JOURNEY"],
    USER_INTERFACE: ["BROWSER_JOURNEY", "NATIVE_JOURNEY"],
    DURABLE_DATA: ["RUNTIME_PROBE", "BROWSER_JOURNEY", "NATIVE_JOURNEY"],
    AUTHORITY: ["RUNTIME_PROBE", "BROWSER_JOURNEY", "NATIVE_JOURNEY", "SECURITY_TEST"],
    PBOS_INTEGRATION: ["RUNTIME_PROBE", "BROWSER_JOURNEY", "NATIVE_JOURNEY"],
    ACCEPTANCE_TEST: ["BROWSER_JOURNEY", "NATIVE_JOURNEY"],
