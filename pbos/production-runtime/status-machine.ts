...
const transitions: Readonly<Record<ProductionStatus, readonly ProductionStatus[]>> = {
    ...
    VALIDATING: ["REPAIRING", "GENERATING_PREVIEW", "AWAITING_APPROVAL", "PAUSED", "COMPLETED", "BLOCKED", "FAILED", "CANCELLED"],
    REPAIRING: ["RUNNING", "VALIDATING", "PAUSED", "BLOCKED", "FAILED", "CANCELLED"],
    GENERATING_PREVIEW: ["VALIDATING", "AWAITING_APPROVAL", "PAUSED", "COMPLETED", "BLOCKED", "FAILED", "CANCELLED"],
